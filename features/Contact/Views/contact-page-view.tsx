  ...
  return (
    <>
      ...
      <main className="relative w-screen h-screen overflow-auto">
        ...
        <div
          className=" mx-auto flex min-h-screen flex-col lg:mt-20 lg:justify-between gap-12 py-24
          
          sd:max-w-[370px]
          540:max-w-[480px]
          sm:max-w-135
          md:max-w-175
          lg:max-w-225 lg:flex-row lg:items-start lg:gap-20 lg:py-32
          xl:max-w-7xl"
        >
          {/* ── LEFT COLUMN ────────────────────────────────────────────────────── */}
          <div className="flex flex-col gap-10 lg:sticky lg:top-32 lg:w-[45%]">
            {/* eyebrow */}
            ...
            <div>
              <h1 className="text-5xl font-bold leading-[1.05] tracking-tight text-white lg:text-6xl">
                ...
                <span
                  ...
                  style={{
                    backgroundImage: "linear-gradient(90deg,#a78bfa,#67e8f9)",
                  }}
                >
                  something
                </span>
              ...
              <p className="mt-5 text-base leading-relaxed text-zinc-500">
                ...
                say hello — my inbox is open. I read every message personally.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {SERVICES.map((s) => (
                  <span
                    key={s}
                    className="rounded-lg border border-white/[0.07]  bg-white/5 backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-zinc-400 transition-all hover:border-violet-500/30 hover:text-violet-300"
                  >
                    {s}
                  </span>
                ))}
            ...
            <div className="flex items-center gap-3">
              {SOCIALS.map(({ icon: Icon, label, href }) => (
                <a
                  ...
                  aria-label={label}
                  className="group flex h-10 w-10 items-center justify-center rounded-xl border border-white/[0.08] bg-white/5 backdrop-blur-md text-zinc-500 transition-all hover:border-violet-500/35 hover:bg-violet-500/10 hover:text-violet-300"
                >
                  <Icon size={16} />
                </a>
              ))}
                ...
                {submitted ? (
                  ...
                  <div className="flex flex-col items-center justify-center gap-6 py-16 text-center">
                    ...
                    <button
                      ...
                      className="rounded-xl border border-white/10 bg-white/5 px-5 py-2.5 text-zinc-300 hover:bg-white/10 hover:text-white transition"
                    >
                      Send another
                    </button>
                  </div>
